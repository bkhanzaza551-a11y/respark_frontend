...
export default function ServiceCategoriesPage() {
  ...
  // Categories are global to the salon, so we do not filter them by branch.
  // The backend already filters the services inside them by branchId.
              ...
              <div style={{ background: "#f8fafc", padding: "16px 20px", borderRadius: 10, border: "1px solid #e2e8f0" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: "#94a3b8", marginTop: 2 }}>Add consumable products used by this service</div>
                  </div>
                ...
                {(() => {
                  ...
                  return consumables.map((c, idx) => (
                      <div key={idx} style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 8, padding: "12px 14px", marginBottom: 8 }}>
                        <div style={{ display: "flex", gap: 10, alignItems: "flex-end" }}>
                          <div style={{ flex: "2 1 120px" }}>
                            <label style={{ ...labelStyle, fontSize: 11, marginBottom: 4 }}>Product</label>
                            <CustomDropdown value={c.productId} onChange={e => {
