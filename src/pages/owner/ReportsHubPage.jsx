...
const COLUMNS = {
  ...
  tip_report: ["SR. NO.", "Date", "Customer", "Phone", "Invoice #", "Staff", "Tip Amount", "Payment Mode"],
  ...
  membership_redemption: ["Date", "Customer", "Membership", "Service Redeemed", "Amount Used"],
  ...
  package_redemption: ["Date", "Customer", "Package", "Service Redeemed", "Amount Used"],
  gift_card_sold: ["Date", "Code", "Customer", "Value", "Expiry", "Branch"],
  gift_card_redemption: ["Date", "Code", "Amount Used", "Invoice #", "Remaining Balance"],
  ...
  gst_returns: ["SR. NO.", "Invoice Date", "Invoice No", "Customer", "Customer GSTN", "HSN/SAC", "Amount", "Qty", "Discount", "Taxable Amount", "Invoice Amount"],
  ...
  consumable_tracking: ["Product", "Service", "Unit", "Qty Used Per Service", "Total Used", "Remaining Stock", "Total Cost"],
  total_consumed: ["Product", "Category", "Unit", "Total Quantity Consumed", "Total Cost"],
...
const REPORT_ENDPOINTS = {
  ...
  membership_redemption: "/owner/reports/membership-redemption",
  inter_store_membership: "/owner/reports/inter-store-membership",
  packages: "/reports/packages",
  package_redemption: "/owner/reports/package-redemption",
  gift_card_sold: "/owner/reports/gift-card-sold",
  gift_card_redemption: "/owner/reports/gift-card-redemption",
  advance_received: "/owner/reports/advance-received",
  balance_received: "/owner/reports/balance-received",
  coupon_redemption: "/owner/reports/coupon-redemption",
  day_wise: "/reports/day-wise",
  tip_report: "/owner/reports/tip",
  complimentary: "/owner/reports/complimentary",
  cancelled_invoices: "/reports/cancelled-invoices",
  appointments: "/reports/appointments",
  gst_returns: "/owner/reports/gst-returns",
  guest_followups: "/owner/reports/guest-followups",
  daily_stock: "/reports/stock?format=daily-stock",
  stock_transaction: "/reports/stock",
  material_received: "/owner/reports/material-received",
  minimum_stock: "/reports/low-stock",
  reconcile_stock: "/owner/reports/reconcile-stock",
  consumable_tracking: "/owner/reports/consumable-tracking",
  total_consumed: "/owner/reports/total-consumed",
  purchase_order: "/owner/reports/purchase-order",
  gst_outwards: "/owner/reports/gst-outwards",
  inventory_transaction: "/owner/reports/inventory-transaction",
  pnl_report: "/owner/reports/pnl",
};
