        ...
        <div className="panel-card">
          ...
          <form className="form-grid" onSubmit={save}>
            ...
            <label>
              ...
              <CustomDropdown value={form.type} onChange={(event) => setForm((current) => ({ ...current, type: event.target.value }))}>
            ...
            <label>
              ...
              <CustomDropdown defaultValue="" onChange={(event) => applyTemplate(event.target.value)}>
            ...
            <label>
              ...
              <CustomDropdown value={form.audienceFilter} onChange={(event) => setForm((current) => ({ ...current, audienceFilter: event.target.value }))}>
            ...
            {form.audienceFilter === "SERVICE_BASED_CUSTOMERS" ? (
              ...
              <CustomDropdown value={form.audienceMeta?.serviceId || ""} onChange={(event) => setForm((current) => ({ ...current, audienceMeta: { ...(current.audienceMeta || {}), serviceId: event.target.value } }))}>
        ...
        <div className="panel-card">
          ...
          <div className="form-grid" style={{ marginBottom: 16 }}>
            ...
            <label>
              ...
              <CustomDropdown value={filters.audienceFilter} onChange={(event) => setFilters((current) => ({ ...current, audienceFilter: event.target.value }))}>
          ...
          <div className="panel-card">
            ...
            {detail && (
              ...
              <CustomDropdown defaultValue={detail.linkedCouponId || ""} onChange={(event) => linkCoupon(detail.id, event.target.value)}>
