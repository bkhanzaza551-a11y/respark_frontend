      ...
      <div className="panel-card">
        <div style={{ display: "flex", flexWrap: "wrap", gap: 16, alignItems: "flex-end", marginBottom: 20 }}>
          ...
          <label style={{ flex: "1 1 200px", display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            <CustomDropdown style={{ padding: "8px 12px", border: "1px solid #cbd5e1", borderRadius: 6 }} value={filters.module} onChange={(event) => setFilters((current) => ({ ...current, module: event.target.value }))}>
          ...
          <label style={{ flex: "1 1 200px", display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            <CustomDropdown style={{ padding: "8px 12px", border: "1px solid #cbd5e1", borderRadius: 6 }} value={filters.action} onChange={(event) => setFilters((current) => ({ ...current, action: event.target.value }))}>
